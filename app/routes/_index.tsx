    ...
    <div className="wrapper">
      ...
      <StackablePair>
        ...
        <h2>
          ...
          with Typescript, NodeJs, and React on AWS, and I'm always learning new
          tech. Check out a couple of my hobby projects below!
        </h2>
      ...
      <StackablePair>
        ...
        <h2>
          ...
          16,000 ChatGPT responses for faster response times, which was a major
          challenge. It is a static site built with Gatsby.
        </h2>
      </StackablePair>
      <StackablePair>
        ...
        <h2>
          ...
          deployed to AWS and integrated with Stripe for payment, relying on AWS
          Lambda for the back end communication. I utilized S3 presigned URLs to
          deliver the products, and deploy with a CI/CD pipeline automatically
          from Github.
        </h2>
      </StackablePair>
